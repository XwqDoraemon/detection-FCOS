...
class ProgressiveSampler(object):
    def __init__(self, dataset, max_epoch):
        ...
        self.train_targets = dataset.label_target   #  hard code，记录各个样本的标签
...
if __name__ == '__main__':
    # 设置路径
    train_dir = "/home/myjian/Workespace/PythonProject/Dataset/cifar10_train"
    check_data_dir(train_dir)
    train_dataset = BDD100kDataset(root_dir= "/home/myjian/Workespace/PythonProject/Dataset/bdd100k",imgset='100k')
    
    max_epoch = 200
    sampler_generator = ProgressiveSampler(train_dataset, max_epoch)
    ...
    for epoch in range(max_epoch):
        ...
        train_loader = DataLoader(dataset=train_dataset, batch_size=2, shuffle=False, num_workers=2,
                                  sampler=sampler)
        labels = []
